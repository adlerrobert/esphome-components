...
#define TWO_PI 6.283185307179586476925286766559005768394338798750211641949889
#define radians(deg) ((deg) * 0.017453292519943295769236907684886127134428718885417254560011330)
#define degrees(rad) ((rad) * 57.295779513082320876798154814105170332405472466564321549160243661)
#define sq(x) ((x) * (x))
