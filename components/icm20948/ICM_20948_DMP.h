...
struct icm_20948_DMP_Activity_t // DMP Activity Recognition data
{
  uint8_t Drive : 1;
  uint8_t Walk : 1;
  uint8_t Run : 1;
...
struct icm_20948_DMP_Secondary_On_Off_t // DMP Secondary On/Off data
{
  uint16_t Gyro_Off : 1;
  uint16_t Gyro_On : 1;
...
struct icm_20948_DMP_data_t
{
  ...
  } PQuat6; // Pedometer quaternion data
  union Geomag
  {
